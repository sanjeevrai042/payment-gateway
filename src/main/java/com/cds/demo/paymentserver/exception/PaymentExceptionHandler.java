package com.cds.demo.paymentserver.exception;
...
import com.cds.demo.paymentserver.dto.ErrorResponse;
...
public class PaymentExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleBadCredentialsException(BadCredentialsException e){
		ErrorResponse errorResponse = ErrorResponse.builder().code(HttpStatus.FORBIDDEN.name())
										.message(e.getMessage())
										.build();
